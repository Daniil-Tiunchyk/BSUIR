...
public class UserDAO {
  ...
  public User createUser(User user) {
    ...
    String sql =
      "INSERT INTO users (first_name, last_name, email, phone_number, password) VALUES (?, ?, ?, ?, ?) RETURNING user_id";
  ...
  public User updateUser(Integer id, Map<String, Object> updates) {
    ...
    updates.forEach((key, value) -> {
      if (key.equals("password")) {
        value =
          org.apache.commons.codec.digest.DigestUtils.sha256Hex((String) value);
      }
