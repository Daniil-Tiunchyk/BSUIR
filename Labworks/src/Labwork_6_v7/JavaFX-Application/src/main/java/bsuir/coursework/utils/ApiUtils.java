...
public class ApiUtils {
    ...
    public static void sendHttpRequestAsync(HttpRequest request, Consumer<String> responseHandler) {
        HttpClient client = HttpClient.newHttpClient();

        client.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                .thenApply(HttpResponse::body)
                .thenAccept(jsonResponse -> Platform.runLater(() -> responseHandler.accept(jsonResponse)));
    }
